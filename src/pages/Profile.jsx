...
export default function Profile() {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>linked-posts/Profile</title>
      </Helmet>
      <div className="h-full bg-gray-200 rounded-lg my-5 p-8 lg:w-2/3  mx-auto">
        <div className="bg-white rounded-lg shadow-xl pb-8">
          ...
          <div className="w-full h-[250px]">
            <img src="https://media.istockphoto.com/id/628660778/photo/early-morning-sunrise-over-sea.jpg?s=612x612&w=0&k=20&c=nlrc6lYpKh8LB1TZPQ3f6rA91TdgbUrgYCmjdzp2XwA=" className="w-full h-full rounded-tl-lg rounded-tr-lg" />
          </div>
          <div className="flex flex-col items-center -mt-20">
            <img src={userData?.photo} className="w-40 border-4 bg-white/50 border-white rounded-full" />
            <div className="flex items-center space-x-2 mt-2">
              <div className='flex flex-col justify-center items-center'>
                <p className="text-2xl text-black">{userData?.name}</p>
            ...
            <div className='flex gap-9 mt-4'>
              <div className='flex flex-col justify-center items-center'>
                ...
                <p className="text-gray-500">{userData?.followersCount}</p>

              </div>
              <div className='flex flex-col justify-center items-center'>
                <p className='text-gray-600'>Following</p>
                <p className="text-gray-500">{userData?.followingCount}</p>
              </div>
        ...
        <div className="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
            ...
            <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
              ...
              <ul className="mt-2 text-gray-700">
                ...
                <li className="flex border-b py-2">
                  <span className="font-bold w-24">user name:</span>
                  <span className="text-gray-700">{userData?.username}</span>
                </li>
                <li className="flex border-b py-2">
                  <span className="font-bold w-24">Birthday:</span>
                  <span className="text-gray-700">{convertDate(userData?.dateOfBirth)}</span>
                </li>
                <li className="flex border-b py-2">
                  <span className="font-bold w-24">Joined:</span>
                  <span className="text-gray-700">{convertDate(userData?.createdAt)}</span>
                </li>
          ...
          <div className='w-full'>
            {data?.data?.data?.posts.map(post => <PostItem postItem={post} key={post._id}></PostItem>)}
